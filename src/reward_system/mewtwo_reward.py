"""
Team Rocket Mewtwo ex + Spidops Specific Strategic Reward Engine.
Contains all Team Rocket / Mewtwo strategic rewards extracted from rewards.py.
"""
...
try:
    ...
    from src.training.card_database import (
        get_card_data, is_defensive_blocker, can_attack, attack_table
    )

def calculate_mewtwo_strategic_reward(pre, post, action_type, step_idx, went_second, player_idx, opponent_name):
    r_strategic = 0.0
