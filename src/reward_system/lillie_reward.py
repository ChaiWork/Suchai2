...
stadium timing, recovery rewards, tactical KO rewards, and endgame checkmate signals.
"""
...
TELEPATHIC_ENERGY_ID = 19    # Telepath Psychic Energy
...
def calculate_lillie_strategic_reward(pre: dict, post: dict, action_type: int, step_idx: int, went_second: bool, player_idx: int, opponent_name: str) -> float:
    ...
    if action_type == 7:
        ...
        # --- B. Supporter Play Rewards ---
            ...
            # Reward higher when opponent active is an ex threat or taken prize
            r_strategic += 0.18
    ...
    # -------------------------------------------------------------------------
    # 4. BENCH DENSITY & TACTICAL STATE REWARDS
    # -------------------------------------------------------------------------
