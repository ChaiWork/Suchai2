...
"""
Rulebasedmodel_Lopunny Rule-based Opponent Agent
Auto-generated from tournament replay 87895972lopuunyy.json
"""

file_path = os.path.join("decks", "Rulebasedmodel_Lopunny", "deck.csv")
if not os.path.exists(file_path):
    file_path = os.path.join("/kaggle_simulations", "agent", "decks", "Rulebasedmodel_Lopunny", "deck.csv")
if not os.path.exists(file_path):
    file_path = "deck.csv"
    if not os.path.exists(file_path):
