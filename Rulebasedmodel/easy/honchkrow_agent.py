...
"""
Rulebasedmodel_Honchkrow Rule-based Opponent Agent
Auto-generated from tournament replay 87826563honcron.json
"""

file_path = os.path.join("decks", "Rulebasedmodel_Honchkrow", "deck.csv")
if not os.path.exists(file_path):
    file_path = os.path.join("/kaggle_simulations", "agent", "decks", "Rulebasedmodel_Honchkrow", "deck.csv")
if not os.path.exists(file_path):
    file_path = "deck.csv"
    if not os.path.exists(file_path):
