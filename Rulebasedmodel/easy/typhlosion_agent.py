...
"""
Rulebasedmodel_Typhlosion Rule-based Opponent Agent
Auto-generated from tournament replay 87890252 (1)typloson.json
"""

file_path = os.path.join("decks", "Rulebasedmodel_Typhlosion", "deck.csv")
if not os.path.exists(file_path):
    file_path = os.path.join("/kaggle_simulations", "agent", "decks", "Rulebasedmodel_Typhlosion", "deck.csv")
if not os.path.exists(file_path):
    file_path = "deck.csv"
    if not os.path.exists(file_path):
