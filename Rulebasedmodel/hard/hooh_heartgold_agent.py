...
"""
Rulebasedmodel_HoOh_HeartGold Rule-based Opponent Agent
Auto-generated from tournament replay 87684768heartofgold.json
"""

file_path = os.path.join("decks", "Rulebasedmodel_HoOh_HeartGold", "deck.csv")
if not os.path.exists(file_path):
    file_path = os.path.join("/kaggle_simulations", "agent", "decks", "Rulebasedmodel_HoOh_HeartGold", "deck.csv")
if not os.path.exists(file_path):
    file_path = "deck.csv"
    if not os.path.exists(file_path):
