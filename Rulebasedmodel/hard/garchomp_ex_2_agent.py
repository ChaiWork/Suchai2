...
"""
Rulebasedmodel_Garchomp_ex_2 Rule-based Opponent Agent
Auto-generated from tournament replay 87700476 (1)garchomp.json
"""

file_path = os.path.join("decks", "Rulebasedmodel_Garchomp_ex_2", "deck.csv")
if not os.path.exists(file_path):
    file_path = os.path.join("/kaggle_simulations", "agent", "decks", "Rulebasedmodel_Garchomp_ex_2", "deck.csv")
if not os.path.exists(file_path):
    file_path = "deck.csv"
    if not os.path.exists(file_path):
