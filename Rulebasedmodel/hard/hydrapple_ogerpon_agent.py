...
"""
Rulebasedmodel_Hydrapple_Ogerpon Rule-based Opponent Agent
Auto-generated from tournament replay 87681763ogepon.json
"""

file_path = os.path.join("decks", "Rulebasedmodel_Hydrapple_Ogerpon", "deck.csv")
if not os.path.exists(file_path):
    file_path = os.path.join("/kaggle_simulations", "agent", "decks", "Rulebasedmodel_Hydrapple_Ogerpon", "deck.csv")
if not os.path.exists(file_path):
    file_path = "deck.csv"
    if not os.path.exists(file_path):
