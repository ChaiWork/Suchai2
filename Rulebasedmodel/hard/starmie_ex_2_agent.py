...
"""
Rulebasedmodel_Starmie_ex_2 Rule-based Opponent Agent
Auto-generated from tournament replay 87683539starmie.json
"""

file_path = os.path.join("decks", "Rulebasedmodel_Starmie_ex_2", "deck.csv")
if not os.path.exists(file_path):
    file_path = os.path.join("/kaggle_simulations", "agent", "decks", "Rulebasedmodel_Starmie_ex_2", "deck.csv")
if not os.path.exists(file_path):
    file_path = "deck.csv"
    if not os.path.exists(file_path):
