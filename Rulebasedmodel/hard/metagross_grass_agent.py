...
"""
Rulebasedmodel_Metagross_Grass Rule-based Opponent Agent
Auto-generated from tournament replay 87705894metagrraass.json
"""

file_path = os.path.join("decks", "Rulebasedmodel_Metagross_Grass", "deck.csv")
if not os.path.exists(file_path):
    file_path = os.path.join("/kaggle_simulations", "agent", "decks", "Rulebasedmodel_Metagross_Grass", "deck.csv")
if not os.path.exists(file_path):
    file_path = "deck.csv"
    if not os.path.exists(file_path):
